            ...
            <div className="row mb-4">
                <div className="col-md-6 bg-white p-3 rounded-3 m-1 w-100">
                    ...
                    <ul className="list-unstyled">
                        ...
                        <li><strong>Telefono:</strong> <a href="tel:+391234567..." className="text-decoration-none">+39 123 456...</a></li>
                        <li><strong>Email:</strong> <a href="mailto:info@example.com" className="text-decoration-none">info@example.com</a></li>
